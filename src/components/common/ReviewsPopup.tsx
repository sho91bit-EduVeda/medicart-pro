...
const ReviewsPopup: React.FC<ReviewsPopupProps> = ({ children }) => {
  ...
  const handleOpenChange = (open: boolean) => {
    setIsOpen(open);
    if (!open) {
      setShowForm(false); // Reset form view when closing
    }
  };

  const handleSubmitReview = (rating: number) => {
    // Review submitted successfully, can show success message or refresh reviews
    setShowForm(false);
  };
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-4 text-white relative overflow-hidden">
          ...
          <DialogHeader className="relative z-10">
            ...
            <DialogDescription className="text-blue-100 text-center mt-1">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center gap-2 pb-4 border-b border-slate-200 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-800 uppercase tracking-wide">Leave a Review</h3>
              </div>
              <StoreReviewForm 
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center gap-2 pb-4 border-b border-slate-200 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-800 uppercase tracking-wide">Customer Reviews</h3>
              </div>
              <StoreReviews />
            </div>
          </div>
